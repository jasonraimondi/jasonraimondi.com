...
{{< image/pop src="./imgs/only-index-page.gif" alt="Only index page" >}}
...
{{< image/pop src="./imgs/todo-add-login-endpoint.gif" alt="Login Page Success" >}}
...
{{< image/pop src="./imgs/alert-with-token.gif" alt="Alert with token" >}}
...
{{< 
  image/pop 
  src="./imgs/you-are-not-logged-in.gif" 
...
{{< image/pop src="./imgs/redirect-to-login.gif" alt="Shows an unauthorized user attempting to view dashboard and being redirected to login." >}}
...
{{< image/pop src="./imgs/login-to-dashboard.gif" alt="Login to dashboard" >}}
...
{{< image/pop src="./imgs/show-logout.gif" alt="Demonstrate a user logout" >}}
